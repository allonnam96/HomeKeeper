          ...
          <Modal onClose={toggleModal} isOpen={modalIsOpen}><LoginForm toggleModal={toggleModal}/></Modal>
            <form className="session-form" onSubmit={handleSubmit}>
                ...
                <div className="user-info">
                    ...
                    <div className="errors">{errors?.birthday}</div>
                    ...
                    {/* <div className='signup-button'>
                      <button
                        className='button signup-click'
                        type="submit"
                        disabled={!email || !name || !birthday.month || !birthday.day || !birthday.year || !password || password !== confirmPassword}
                      >
                        Sign Up
                      </button>
                    </div> */}
                    <div className='signup-button'>
                      <button
                        className={`button signup-click ${(!email || !name || !birthday.month || !birthday.day || !birthday.year || !password || password !== confirmPassword) ? 'disabled' : ''}`}
                        type="submit"
                        disabled={!email || !name || !birthday.month || !birthday.day || !birthday.year || !password || password !== confirmPassword}
                      >
                        Sign Up
